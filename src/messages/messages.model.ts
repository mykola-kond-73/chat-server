...
export class Message extends Model<Message, MessageCreateAttrs> {
  @ApiProperty({
    ...
    description: 'Id повідомлення. Задається автоматично',
  })
  ...
  @ApiProperty({
    example: '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d',
    description: 'Id автора повідомлення',
  })
  ...
  @ApiProperty({
    example: '2022-06-23T13:10:28.071Z',
    description: 'Точна дата нодсилання повідомлення',
  })
  ...
  //! має бути за документацією, але викликає помилку і працює без цього
  @BelongsTo(() => Room)
  room: Room;
}
